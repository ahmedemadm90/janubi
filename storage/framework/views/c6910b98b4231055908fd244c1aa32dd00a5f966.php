            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="" class="slide-item"> المستخدمين</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                    ...
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Apps</a></li>
                        <li><a href="" class="slide-item"> المناطق</a></li>
                        <li><a href="" class="slide-item"> منطقة جديدة</a></li>
                    </ul>
                </li>
            </ul>
...
<?php /**PATH /storage/ssd5/961/20389961/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>