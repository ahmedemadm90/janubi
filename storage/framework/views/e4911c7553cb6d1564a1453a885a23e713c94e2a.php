            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="<?php echo e(route('users')); ?>" class="slide-item"> Users</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                            class="side-menu__icon fe fe-slack"></i><span class="side-menu__label">ADs</span><i
                            class="angle fe fe-chevron-right"></i></a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Apps</a></li>
                        <li><a href="<?php echo e(route('ads')); ?>" class="slide-item"> All ADs</a></li>
                        <li><a href="<?php echo e(route('ads.create')); ?>" class="slide-item"> New AD</a></li>
                    </ul>
                </li>
            </ul>
...
<?php /**PATH H:\Laravel\janubi working auth\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>